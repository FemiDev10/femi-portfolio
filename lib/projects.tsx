      ...
      <div className="w-full h-full bg-[#0b0f1e] flex items-center justify-center px-5 relative overflow-hidden">
        ...
        <div style={{ display: "flex", gap: 10, width: "100%", maxWidth: 220, height: 160, padding: "12px 0", position: "relative" }}>
          <div style={{ width: 52, flexShrink: 0, display: "flex", flexDirection: "column", gap: 6, paddingTop: 4 }}>
            {[{ w: 40, active: true }, { w: 36, active: false }, { w: 44, active: false }, { w: 32, active: false }, { w: 42, active: false }, { w: 38, active: false }].map((item, i) => (
              <div key={i} style={{ height: 5, width: item.w, borderRadius: 3, background: item.active ? "#2C3ADF" : "rgba(255,255,255,0.08)" }} />
            ))}
          </div>
        ...
        <div style={{ position: "absolute", top: 14, right: 14 }}>
          <span style={{ fontSize: 8, fontWeight: 600, color: "#7b8ef7", background: "rgba(44,58,223,0.15)", border: "1px solid rgba(44,58,223,0.3)", padding: "2px 7px", borderRadius: 20, letterSpacing: "0.02em" }}>Redocly</span>
        </div>
        <div style={{ position: "absolute", bottom: 14, left: 14 }}>
          <span style={{ fontSize: 8, color: "rgba(255,255,255,0.25)", letterSpacing: "0.08em", textTransform: "uppercase", fontFamily: "monospace" }}>DevX · API Docs</span>
        </div>
      </div>
    ),
  },
  ...
  },
  {
    ...
    thumbnail: (
      <div className="w-full h-full bg-[#0a0e1a] flex items-center justify-center relative overflow-hidden">
        ...
        <div style={{ width: 78, height: 140, background: "#111827", borderRadius: 18, border: "1.5px solid rgba(255,255,255,0.08)", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "0 20px 48px rgba(0,0,0,0.7)" }}>
        ...
        <div style={{ position: "absolute", bottom: 14, left: 14 }}>
          <span style={{ fontSize: 8, color: "rgba(255,255,255,0.2)", letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "monospace" }}>Driver · iOS</span>
        </div>
        <div style={{ position: "absolute", top: 14, right: 14 }}>
  ...
  },
  {
    ...
    thumbnail: (
      <div className="w-full h-full bg-[#f5f4f0] flex items-center justify-center relative overflow-hidden">
        ...
        <div style={{ width: 78, height: 140, background: "#fff", borderRadius: 18, border: "1px solid rgba(0,0,0,0.08)", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "0 12px 36px rgba(0,0,0,0.12)" }}>
        ...
        <div style={{ position: "absolute", bottom: 14, left: 14 }}>
          <span style={{ fontSize: 8, color: "rgba(0,0,0,0.25)", letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "monospace" }}>Rider · iOS</span>
        </div>
        <div style={{ position: "absolute", top: 14, right: 14 }}>
  ...
  },
  {
    ...
    thumbnail: (
      <div className="w-full h-full bg-[#0d1117] flex items-center justify-center relative overflow-hidden">
        ...
        <div style={{ width: 64, height: 82, background: "#1a1f2e", borderRadius: 12, border: "1.5px solid rgba(255,255,255,0.12)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 6, position: "relative", boxShadow: "0 8px 32px rgba(0,0,0,0.6)" }}>
        ...
        <div style={{ position: "absolute", width: 90, height: 110, border: "1px solid rgba(99,179,237,0.08)", borderRadius: 18, pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: 14, left: 14 }}>
          <span style={{ fontSize: 8, color: "rgba(255,255,255,0.3)", letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "monospace" }}>HCI · WEARABLE · EE</span>
        </div>
        <div style={{ position: "absolute", top: 14, right: 14 }}>
          <span style={{ fontSize: 9, fontWeight: 500, color: "#63b3ed", background: "rgba(99,179,237,0.1)", border: "1px solid rgba(99,179,237,0.2)", padding: "2px 7px", borderRadius: 20, letterSpacing: "0.02em" }}>93%</span>
        </div>
      </div>
    ),
  },
    ...
    thumbnail: (
      <div className="w-full h-full bg-[#0a0a0a] flex items-center justify-center relative">
        <div className="flex flex-col items-center">
          ...
          <span className="mt-2 bg-[#f5c518] text-[#0a0a0a] text-[9px] font-medium px-2 py-0.5 rounded-full tracking-wider">DESIGN SYSTEM</span>
        </div>
