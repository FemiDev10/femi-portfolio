...
function Label({ children }: { children: ReactNode }) {
  return (
    <p style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.12em", color: "#aaa", fontFamily: "monospace", textAlign: "center", marginTop: 12, marginBottom: 0 }}>
      {children}
    </p>
  );
}
...
export default function MerchantPortalPage() {
  return (
    <main style={{ background: "#fff", color: "#111" }}>
      ...
      {/* ── HERO TEXT ── */}
      <section className="mp-sec" style={{ paddingBottom: 48 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <p style={{ fontSize: 11, color: "#bbb", letterSpacing: "0.08em", marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 18, color: "#aaa", fontWeight: 300, marginTop: 20, maxWidth: 640, lineHeight: 1.6 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 32 }}>
            {["Product Designer", "Paymi Solutions", "Jun 2024 – Ongoing", "Web App"].map((t) => (
              <span key={t} style={{ background: "#f5f5f5", border: "1px solid #e8e8e8", color: "#666", borderRadius: 20, padding: "5px 14px", fontSize: 11 }}>
                {t}
              </span>
            ))}
          </div>
      ...
      <div>
        <BrowserMockup
          ...
          bg="#e8edf0"
        />
        <p style={{ textAlign: "center", fontSize: 10, color: "#aaa", fontFamily: "monospace", textTransform: "uppercase", padding: "16px 0" }}>
          ...
          <div className="mp-two-col">
            ...
            <div className="mp-stat-grid">
              {[
                ...
                <div key={label}>
                  <p style={{ fontSize: "clamp(40px, 5vw, 56px)", fontWeight: 400, color: "#111", letterSpacing: "-0.04em", lineHeight: 1, margin: "0 0 6px" }}>{num}</p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div className="mp-nav-col">
            ...
            <div style={{ background: "#111", borderRadius: 12, padding: 32, width: "fit-content", minWidth: 260 }}>
              <div style={{ fontSize: 13, color: "#fff", lineHeight: 2.4, paddingLeft: 12, borderLeft: "2px solid #4a6cf7" }}>
                Dashboard
              </div>
            ...
            <div>
              ...
              <p className="mp-body">
                Business Tools surfaces money-generating actions first. Incoming shows what arrived. Outgoing shows what left. That sequence — generate, receive, send — mirrors how merchants actually think through their day. Support, Developer Tools, and Settings sit below because they&apos;re not part of the daily flow.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mp-sec" style={{ borderTop: "1px solid #f0f0f0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(36px, 5vw, 64px)", fontWeight: 400, letterSpacing: "-0.04em", color: "#111", maxWidth: 760, lineHeight: 1.05, marginBottom: 64 }}>
            Five things that were quietly failing merchants.
          </h2>
          {[
            ...
            { num: "04", title: "Settlements were a black box", body: "When does my money arrive? Why is the balance …0.00? Is this an error? These questions filled support channels because the product had no answers on screen." },
      ...
      {/* ── ONBOARDING ── */}
      <section className="mp-sec" style={{ background: "#f8f9ff", borderTop: "1px solid #f0f0f0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SecLabel>Onboarding</SecLabel>
          <h2 className="mp-h2">Getting in.</h2>
          <p style={{ fontSize: 18, color: "#aaa", fontWeight: 300, marginBottom: 64, lineHeight: 1.6 }}>
            Login, signup, email verification, password reset — every entry point designed for first-time merchants.
          </p>
          <div className="mp-screen-scroll">
            {[
              ...
              <div key={label} style={{ flexShrink: 0, width: 320 }}>
                <BrowserMockup src={src} alt={label} bg="#e8edf5" />
                <Label>{label}</Label>
              </div>
            ))}
          </div>
      ...
      <section className="mp-sec" style={{ borderTop: "1px solid #f0f0f0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p className="mp-body" style={{ marginBottom: 64 }}>
            The top navigation bar carries a red &apos;Test Mode&apos; badge and a &apos;Switch to live&apos; prompt throughout the pre-live phase. The dashboard subtitle says &apos;Want to switch to live mode? Activate your business&apos; with an Activate Account CTA. We designed <strong style={{ fontWeight: 500, color: "#111" }}>six distinct dashboard states</strong>: Empty, Test Active, Test Inactive, Live Active, Live Inactive, and Filled. Each reflects a different moment in the merchant journey.
          </p>
          <div className="mp-grid-2" style={{ marginBottom: 48 }}>
            <div>
              <BrowserMockup src="/merchantPortal/dashboard/Dashboard%20Empty%20State.png" alt="Dashboard Empty State" bg="#e8edf0" />
              <Label>Dashboard — Test Mode (Empty State)</Label>
            </div>
            <div>
              <BrowserMockup src="/merchantPortal/dashboard/Dashboard%20Filled%20State.png" alt="Dashboard Filled State" bg="#e8edf0" />
              <Label>Dashboard — Live Mode (Filled State)</Label>
            </div>
          </div>
          <div>
            <BrowserMockup src="/merchantPortal/dashboard/USD%20Dashboard.png" alt="USD Dashboard" bg="#e8f0ff" />
            <Label>Dashboard — USD Wallet Added (New Feature)</Label>
            <p style={{ textAlign: "center", fontSize: 13, color: "#777", fontWeight: 300, marginTop: 12 }}>
              New: merchants can now see total available balance in both NGN and USD from a single dashboard.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mp-sec" style={{ background: "#fff8f0", borderTop: "1px solid #f0f0f0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p className="mp-body" style={{ marginBottom: 16 }}>We shaped each business type into its own guided journey:</p>
          <ul style={{ fontSize: 16, color: "#555", fontWeight: 300, lineHeight: 2, marginBottom: 20, paddingLeft: 0, listStyle: "none" }}>
            <li>• <strong style={{ fontWeight: 500, color: "#111" }}>Sole Proprietor</strong> → Payout Account → Sole Details → Business Information</li>
            <li>• <strong style={{ fontWeight: 500, color: "#111" }}>Private LLC</strong> → Payout Account → Director Details → Shareholder Details → Business Details</li>
          ...
          <p className="mp-body" style={{ marginBottom: 48 }}>
            Merchants select their type once, and from there the product walks them through only what applies to them. At the end: a &apos;BA in Review&apos; confirmation state. No ambiguity about what happens next.
          </p>

          {/* Business type pills */}
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginBottom: 48 }}>
            {["Sole Proprietor", "Private LLC", "Public LLC", "NGO", "Gov Body", "Professional Body"].map((t) => (
              <span key={t} style={{ border: "1px solid #e8d8c0", background: "#fff8f0", color: "#8a6020", borderRadius: 20, padding: "5px 16px", fontSize: 13 }}>
                {t}
              </span>
            ))}
          </div>
      ...
      {/* ── KEY SCREENS ── */}
      <section className="mp-sec" style={{ background: "#111" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SecLabel style={{ color: "#444" }}>Key Screens</SecLabel>
          <h2 style={{ fontSize: "clamp(40px, 6vw, 72px)", fontWeight: 400, letterSpacing: "-0.04em", color: "#fff", lineHeight: 0.95, marginBottom: 64 }}>
            The full product.
          </h2>

          {/* Transactions & Finance */}
          <p style={{ fontSize: 10, color: "#444", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 24 }}>Transactions &amp; Finance</p>
          ...
          {/* Settlements & Payouts */}
          <p style={{ fontSize: 10, color: "#444", textTransform: "uppercase", letterSpacing: "0.12em", marginTop: 56, marginBottom: 24 }}>Settlements &amp; Payouts</p>
          ...
          {/* Settings & Account */}
          <p style={{ fontSize: 10, color: "#444", textTransform: "uppercase", letterSpacing: "0.12em", marginTop: 56, marginBottom: 24 }}>Settings &amp; Account</p>
          <div className="mp-grid-3" style={{ marginBottom: 20 }}>
            {[
          ...
          {/* Developer Tools */}
          <p style={{ fontSize: 10, color: "#444", textTransform: "uppercase", letterSpacing: "0.12em", marginTop: 56, marginBottom: 24 }}>Developer Tools</p>
          <div className="mp-grid-3">
            {[
      ...
      <section className="mp-sec" style={{ borderTop: "1px solid #f0f0f0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "clamp(28px, 4vw, 52px)", fontStyle: "italic", fontWeight: 300, color: "#111", letterSpacing: "-0.03em", maxWidth: 820, lineHeight: 1.2, marginBottom: 48 }}>
          ...
          {[
            ...
            <div key={item} style={{ borderTop: "1px solid #f0f0f0", padding: "20px 0" }}>
      ...
      <section style={{ padding: "64px 48px", borderTop: "1px solid #f0f0f0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 64, paddingTop: 32, borderTop: "1px solid #f0f0f0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
      ...
      <style>{`
        ...
        .mp-screen-scroll::-webkit-scrollbar { display: none; }

        /* ── Screen grids ── */
        .mp-grid-3 { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; }
        .mp-grid-2 { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; }
        .mp-kyb-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px; }
